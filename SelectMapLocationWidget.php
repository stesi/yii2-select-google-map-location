...
class SelectMapLocationWidget extends InputWidget
{
    ...
    public $attributePostalCode;
    public $attributeProvince;
    public $attributeCity;
    public $attributeStreetNumber;
    public $showPositionInputs = true;
    ...
    public function init()
    {
        ...
        $this->id = uniqid('map_');
        if ($this->showPositionInputs) {
            $routeFields = [
                'route' => '#' . Html::getInputId($this->model, $this->attributeRoute),
                'postal_code' => '#' . Html::getInputId($this->model,  $this->attributePostalCode),
                'province' => '#' . Html::getInputId($this->model,  $this->attributeProvince),
                'city' => '#' . Html::getInputId($this->model,  $this->attributeCity),
                'street_number'=> '#' . Html::getInputId($this->model,  $this->attributeStreetNumber),
            ];
        } else {
            $routeFields = [];
        }
